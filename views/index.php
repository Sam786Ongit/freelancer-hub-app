                    ...
                    <div class="col-md-4">
                        <div class="card card-profile services-card">
                            ...
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-primary btn-round" data-toggle="modal" data-target="#myModal<?php echo $post['id']?>">
                                    Request Quote
                                </button>
                            </div>
                        </div>
                                ...
                                <form class="form" method="post" action="<?php echo ROOT_PATH_FOR_ACTIONS?>/posts/requestqoute.php">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="number" placeholder="" name="requester_phone"
                                                required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Message</label>
                                            <input type="text" class="form-control" id="message" placeholder="" name="requester_message"
                                                required>
                                        </div>
                                    </div>
                                    <!-- Modal footer -->
