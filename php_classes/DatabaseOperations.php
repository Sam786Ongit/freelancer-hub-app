...
class DatabaseOperations{
    ...
    public function deleteFromTable(string $table_name, string $conditions)
    {
        //return 'hello';
        // check if given table exists in the database
        $table_exists = mysqli_query($this->db_conn, "SELECT 1 FROM $table_name");
    ...
    public function getDataFromTable(string $table_name, array $table_columns=[], array $column_values = [],$logical_operation = "and", $additional = "")
    {
        //return 'hello';
        // check if given table exists in the database
        $table_exists = mysqli_query($this->db_conn, "SELECT 1 FROM $table_name");
